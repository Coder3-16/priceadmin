...
import no.bring.priceengine.admin.PriceadminApp;
import no.bring.priceengine.admin.domain.Authority;
import no.bring.priceengine.admin.domain.User;
import no.bring.priceengine.admin.repository.AuthorityRepository;
...
import no.bring.priceengine.admin.web.rest.errors.ExceptionTranslator;
import no.bring.priceengine.admin.web.rest.vm.KeyAndPasswordVM;
import no.bring.priceengine.admin.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = PriceadminApp.class)
